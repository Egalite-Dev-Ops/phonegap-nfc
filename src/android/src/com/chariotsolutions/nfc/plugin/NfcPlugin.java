...
public class NfcPlugin extends CordovaPlugin implements NfcAdapter.OnNdefPushCompleteCallback {
  ...
  private void createPendingIntent() {
    if (pendingIntent == null) {
      ...
      if (ndroid.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
   ...
   *
   * @param tech TagTechnology class name e.g. 'android.nfc.tech.IsoDep' or
  ...
  /**
   * Disable I/O operations to the tag from this TagTechnology object, and
   * release resources.
   *
   * @param callbackContext Cordova callback context
   */
